...
_clients = [
    ...
    {'name': '80cli1', 'port': '8030', 'odoover': '8.0',
     'repos': [
         ...
         {'usr': 'jobiols', 'repo': 'adhoc-account-payment', 'branch': '8.0'},
         {'usr': 'jobiols', 'repo': 'adhoc-stock', 'branch': '8.0'},
         {'usr': 'jobiols', 'repo': 'odoo-web', 'branch': '8.0'},
         {'usr': 'jobiols', 'repo': 'web', 'branch': '8.0'},
         {'usr': 'jobiols', 'repo': 'jeo', 'branch': '8.0'},
         {'usr': 'jobiols', 'repo': 'server-tools', 'branch': '8.0'},
     ...
     #######################################################################
    {'name': 'db8251', 'port': '8251', 'odoover': '8.0',
     'repos': [
         {'usr': 'jobiols', 'repo': 'odoo-argentina', 'branch': '8.0'},
    ...
    {'name': 'plantilla', 'port': '8020', 'odoover': '9.0',
     'repos': [
         ...
         {'usr': 'CybroOdoo', 'repo': 'CybroAddons', 'branch': '9.0'},
         {'usr': 'it-projects-llc', 'repo': 'access-addons', 'branch': '9.0'},
         {'usr': 'ju-san', 'repo': 'report_xls', 'branch': '9.0'},
         {'usr': 'OCA', 'repo': 'delivery-carrier', 'branch': '9.0'},
         {'usr': 'OCA', 'repo': 'pos', 'branch': '9.0'},
    ...
    #######################################################################
    {'name': 'plantilla2', 'port': '8021', 'odoover': '9.0',
     'repos': [
         {'usr': 'jobiols', 'repo': 'customer', 'branch': '9.0'},
         {'usr': 'jobiols', 'repo': 'odoo-addons', 'branch': '9.0'},
         {'usr': 'jobiols', 'repo': 'odoo-argentina', 'branch': '9.0'},
...
#######################################################################
 {'name': 'ferreteriasyp1', 'port': '9121', 'odoover': '9.0', #longpoolig 6121
     'repos': [
         {'usr': 'jobiols', 'repo': 'customer', 'branch': '9.0'},
         {'usr': 'jobiols', 'repo': 'odoo-addons', 'branch': '9.0'},
         {'usr': 'jobiols', 'repo': 'odoo-argentina', 'branch': '9.0'},
     ...
     'images': [
         ...
         #######################################################################
    {'name': 'coleccion-1', 'port': '5021', 'odoover': '9.0',
     'repos': [
         {'usr': 'jobiols', 'repo': 'customer', 'branch': '9.0'},
         {'usr': 'jobiols', 'repo': 'odoo-addons', 'branch': '9.0'},
         {'usr': 'jobiols', 'repo': 'odoo-argentina', 'branch': '9.0'},
         ...
         #{'usr': 'odoo', 'repo': 'odoo-extra', 'branch': '9.0'},
         #{'usr': 'JayVora-SerpentCS', 'repo': 'SerpentCS_Contributions', 'branch': '9.0'},
